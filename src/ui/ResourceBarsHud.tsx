...
const BARS: {
  ...
  { id: 'legna', fill: '#E8B923', iconBg: '#C9A227', icon: 'L' },
  { id: 'acqua', fill: '#4FC3F7', iconBg: '#0288D1', icon: 'A' },
  { id: 'impegno', fill: '#AB47BC', iconBg: '#6A1B9A', icon: 'I' },
];
  ...
  return (
    <View style={styles.wrap} pointerEvents="none">
      {BARS.map((bar) => {
        ...
        return (
          <View key={bar.id} style={styles.row}>
